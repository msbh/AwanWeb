<%@ Page Title="- Select Vehicle to Order -" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="order1.aspx.vb" Inherits="order1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="myform">
        ...
        <h1 class="myform_heading">
            ...
            <%=appdata.GetLanguageString("Order1.heading")%>
            </h1>
        ...
        <div class="content js_a" >
           ...
           <fieldset> <legend>   <%=appdata.GetLanguageString("Stockorder")%>  </legend>
               <ul>
                   <asp:DataList ID="DataList1" runat="server" DataKeyField="Order_ID" DataSourceID="odsSelect_CO">
                       <HeaderTemplate>
                           <tr style="border: thin dotted #FFFFFF; font-size: 14px; color: #C0C0C0; font-weight: bold;">
                               <td>
                                  &nbsp;  <%=appdata.GetLanguageString("StockRef")%>
                               </td>
                               <td>
                                     <%=appdata.GetLanguageString("MakeDescription")%>
                               </td>
                               <td>
                                     <%=appdata.GetLanguageString("Price")%>&nbsp;
                               </td>
                               <td>
                                   &nbsp; <%=appdata.GetLanguageString("SelectStock")%>
                               </td>
                               <td>
                                   &nbsp;
                               </td>
               ...
               <center style="margin: 4px;">
                   <a href="stocklist.aspx?lv=1"><%=appdata.GetLanguageString("Back")%> </a><a href="order.aspx"><%=appdata.GetLanguageString("Next")%>  
