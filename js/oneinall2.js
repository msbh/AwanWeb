...
// FROM: js/jquery-ui-1.8.16.custom.min.js
/*!
 * jQuery UI 1.8.16
 *
...
// FROM: js/ui/jquery.ui.widget.js
/*!
 * jQuery UI Widget 1.8.16
 *
 * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about)
...
// FROM: js/ui/jquery.ui.datepicker.js
/*
 * jQuery UI Datepicker 1.8.16
 *
 * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about)
...
// FROM: js/ui/jquery.ui.button.js
/*
 * jQuery UI Button 1.8.16
 *
 * Copyright 2011, AUTHORS.txt (http://jqueryui.com/about)
...
// FROM: js/jquery.advancedSlider.min.js
(function(h) {
    function Oa(ra, T) {
        function I() {
            ...
            else if (parseInt(h.browser.version) == 8) n.addClass("ie8");
            else parseInt(h.browser.version) == 9 && n.addClass("ie9");
            ...
            width: c.settings.width,
                ...
                if (c.settings.timerAnimation && c.settings.fadeTimer && C != "stop" && !E) {
                    ...
                    h.browser.msie && parseInt(h.browser.version) < 9 ? f.css("filter", "") : f.stop().animate({
                        opacity: 1
                    }, c.settings.timerFadeDuration)
                }
                U = true;
                c.settings.slideshow && c.settings.pauseSlideshowOnHover && C != "stop" && !E && fa();
                Z && c.settings.hideCaption && Ea();
                if (c.settings.navigationArrows && c.settings.fadeNavigationArrows) h.browser.msie && parseInt(h.browser.version) < 9 ? n.find(".navigation-arrows a").stop().show() : n.find(".navigation-arrows a").stop().animate({
                    opacity: 1
                ...
                if (c.settings.timerAnimation && c.settings.fadeTimer && C != "stop" && !E) {
                    var f = n.find(".timer-animation");
                    h.browser.msie && parseInt(h.browser.version) < 9 ? f.css("opacity", 0) : f.stop().animate({
                        opacity: 0
                    }, c.settings.timerFadeDuration)
                }
                U = false;
                c.settings.slideshow && c.settings.pauseSlideshowOnHover && C != "stop" && !E && !ga && sa();
                ...
                if (c.settings.slideshowControls && c.settings.fadeSlideshowControls) h.browser.msie && parseInt(h.browser.version) < 9 ? n.find(".slideshow-controls").stop().hide() : n.find(".slideshow-controls").stop().animate({
                    opacity: 0
            ...
            if (c.settings.slidesPreloaded) {
                Ga();
                for (var a = 0, b = c.settings.slidesPreloaded == -1 ? w.length : c.settings.slidesPreloaded, d = 0; d < b; d++) h("<img/>").load(function() {
                    a++;
                    if (a == b) {
                        ta();
        ...
        function Qa() {
            var a = w.length,
                b = h('<div class="navigation-buttons"></div>').appendTo(A);
            ...
            if (c.settings.fadeNavigationButtons) {
                h.browser.msie && parseInt(h.browser.version) < 9 ? b.hide() : b.css("opacity", 0);
                n.hover(function() {
        ...
        function Ra() {
            var a = h('<div class="shadow"></div>').appendTo(n),
                b = h('<div class="shadow-left"></div>').appendTo(a),
                d = h('<div class="shadow-middle"></div>').appendTo(a),
                f = h('<div class="shadow-right"></div>').appendTo(a);
            a.css({
                width: A.outerWidth(),
                top: A.outerHeight()
            });
        ...
        function Ua(a) {
            if (w[a].thumbnail) {
                var b = A.find(".navigation-buttons a").eq(a),
                    d = w[a].thumbnail,
                    f = h('<div class="thumbnail"></div>').css({
                        width: c.settings.thumbnailWidth,
                        height: c.settings.thumbnailHeight
                    }).appendTo(n.find(".navigation-buttons .buttons")),
                    i = parseInt(b.position().left) - (parseInt(f.outerWidth(true)) - parseInt(b.css("width"))) / 2;
                ...
                if (w[a].thumbnailCaption) {
                    ...
                    a = h('<div class="content">' + w[a].thumbnailCaption + "</div>").appendTo(i);
        ...
        function Q(a) {
            ...
            h.isFunction(c.settings.slideOpen) && c.settings.slideOpen.call(this, a)
        }
        function aa() {
        ...
        function Ga() {
            var a = h('<div class="preloader"></div>').hide().appendTo(n),
        ...
        function Ha() {
            var a = w[z],
                b = a.properties,
                d = b.alignType,
                f = b.htmlDuringTransition,
                i = parseInt(b.horizontalSlices),
                e = parseInt(b.verticalSlices),
                g = b.slicePattern,
                j = b.effectType,
                m = b.slicePoint,
                o = b.slideStartPosition,
                s = parseFloat(b.slideStartRatio),
                u = parseInt(b.sliceDuration),
                k = b.sliceEasing,
                r = parseInt(b.sliceDelay),
                v = b.sliceFade == true || j == "fade" ? 0 : 1,
                t = b.simpleSlideDirection,
                p = b.simpleSlideDuration,
                y = b.simpleSlideEasing;
            ...
            if (L != -1) {
                ...
                var W = w[L].height,
                    ba = a.width,
                    ca = a.height;
                if (j != "simpleSlide" && (fadePreviousSlide == true || ba < c.settings.width && ba < M || ca < c.settings.height && ca < W)) N.fadeOut(fadePreviousSlideDuration)
            }
            ...
            B.hover(function() {
                ...
                h.isFunction(c.settings.slideClick) && c.settings.slideClick.call(this, R)
            });
            M = Math.floor(Math.min(a.width, c.settings.width) / i);
            W = Math.floor(Math.min(a.height, c.settings.height) / e);
            ba = a.width > c.settings.width ? Ia(d, a.width, c.settings.width) : 0;
            d = a.height > c.settings.height ? Ja(d, a.height, c.settings.height) : 0;
            ca = a.width < c.settings.width ? Math.floor((c.settings.width - a.width) / 2) : 0;
            var Ka = a.height < c.settings.height ? Math.floor((c.settings.height - a.height) / 2) : 0,
                La = [];
            b.slideMask && B.css("overflow", "hidden");
            if (j == "random") j = da(["scale", "width", "height", "slide", "fade", "simpleSlide"]);
            if (j == "simpleSlide") {
              ...
              //    "background-position": -ba + ca + "px " + (-d + Ka) + "px",
                            "background-repeat": "no-repeat"
                }).appendTo(ia);
                if (a.html && f) {
                    b = ja ? h("<div>" + a.html + "</div>").clone() : a.html.clone();
                    b.css({
                        left: 0,
                        top: 0,
                        width: c.settings.width,
                ...
                N && N.appendTo(ia);
                if (t == "random") t = da(["autoHorizontal", "autoVertical", "rightToLeft", "leftToRight", "topToBottom", "bottomToTop"]);
                j = {};
                var F, K;
                switch (t) {
                    case "autoHorizontal":
                ...
                for (t = 0; t < i; t++) for (p = 0; p < e; p++) {
                    ...
                    a.path && y.css({
                        "background-image": "url(" + a.path + ")",
                       "background-position": -(t * M + ba) + "px " + -(p * W + d) + "px",
                ...
                if (g == "random") g = da(["randomPattern", "topToBottom", "bottomToTop", "leftToRight", "rightToLeft", "topLeftToBottomRight", "topRightToBottomLeft", "bottomLeftToTopRight", "bottomRightToTopLeft", "horizontalMarginToCenter", "horizontalCenterToMargin", "marginToCenter", "verticalCenterToMargin", "skipOneTopToBottom", "skipOneBottomToTop", "skipOneLeftToRight", "skipOneRightToLeft", "skipOneHorizontal", "skipOneVertical", "spiralMarginToCenterCW", "spiralMarginToCenterCCW", "spiralCenterToMarginCW", "spiralCenterToMarginCCW"]);
                if (i == 1 && e == 1) g = "topToBottom";
                if (m == "random") m = da(["leftTop", "leftCenter", "leftBottom", "centerTop", "centerCenter", "centerBottom", "rightTop", "rightCenter", "rightBottom"]);
                if (o == "random") o = da(["left", "right", "top", "bottom", "leftTop", "rightTop", "leftBottom", "horizontalAlternative", "verticalAlternative"]);
                f = Wa(La, g, i, e);
                i = f.length;
                for (t = 0; t < i; t++) Xa(f[t], t, i, j, m, o, s, u, k, r)
            }
            j = {
        ...
        function va() {
            var a = w[z],
                ...
                d = Ia(b, a.width, c.settings.width);
            b = Ja(b, a.height, c.settings.height);
            var f = a.properties.effectType,
                i = a.properties.htmlDuringTransition;
            E = false;
            if (f != "simpleSlide") {
            ...
            if (c.settings.lightbox && a.lightbox) {
                ...
                B.click(function() {
                    ...
                    h.prettyPhoto.changeSettings({
                        ...
                        current_position: c.settings.lightboxNavigation ? e : -1
                    });
                    c.settings.lightboxNavigation ? h.prettyPhoto.open(X, ka, la) : h.prettyPhoto.open(X[e], ka[e], la[e])
                })
            }
            N && N.remove();
            c.settings.slideshow && C != "stop" && ua();
            c.settings.slideshow && c.settings.pauseSlideshowOnHover && U && fa();
            a.caption && Ya();
            d = {
        ...
        function Xa(a, b, d, f, i, e, g, j, m, o) {
            var s = {},
                ...
                p, y;
            if (f == "scale" || f == "width" || f == "height") switch (i) {
                case "centerCenter":
                    y = t + r * 0.5;
                    p = v + k * 0.5;
                    break;
        ...
        function Ya() {
            ...
            if (!c.settings.hideCaption || c.settings.hideCaption && U) Ea()
        }
        function Ea() {
            var a = w[z],
                b = a.properties,
                d = b.captionPosition,
                f = parseInt(b.captionSize),
                i = parseInt(b.captionWidth),
                e = parseInt(b.captionHeight),
                g = parseInt(b.captionLeft),
                j = parseInt(b.captionTop),
                m = b.captionShowEffect,
                o = parseInt(b.captionShowEffectDuration),
                s = b.captionShowEffectEasing,
                u = b.captionShowSlideDirection,
                k = Math.min(a.width, c.settings.width);
            ...
            k = A.find(".caption");
            a = k.find(".wrapper");
            var r = a.find(".background"),
                v = a.find(".content"),
                t = b.captionBackgroundOpacity;
            b = b.captionBackgroundColor;
            var p = m == "fade" ? 0 : f;
            switch (d) {
                case "left":
        ...
        function Fa(a) {
            var b = A.find(".caption"),
                ...
                e = w[z].properties,
                g = e.captionPosition,
                j = e.captionHideEffect,
                m = parseInt(e.captionHideEffectDuration),
                o = e.captionHideEffectEasing;
        ...
        function Za(a) {
            var b = document.createElement("canvas"),
                ...
                i = Math.PI / 180,
                e = 0,
                g, j, m = c.settings.timerStrokeOpacity1,
                o = c.settings.timerStrokeOpacity2,
                s = Y(c.settings.timerStrokeColor1).red,
                u = Y(c.settings.timerStrokeColor1).green,
                k = Y(c.settings.timerStrokeColor1).blue,
                r = Y(c.settings.timerStrokeColor2).red,
                v = Y(c.settings.timerStrokeColor2).green,
                t = Y(c.settings.timerStrokeColor2).blue;
            b.width = b.height = d;
            h(b).attr("class", "timer-animation").appendTo(A);
            if (c.settings.fadeTimer && !U) h(b).css("opacity", 0);
            else h.browser.msie && parseInt(h.browser.version) < 9 || h(b).css({
                opacity: 0
            }).stop().animate({
                opacity: 1
            }, c.settings.timerFadeDuration);
            ...
            wa = setInterval(function() {
                if (e <= 360 && !(c.settings.pauseSlideshowOnHover && U || ga)) {
                    g = (new Date).getTime();
                    j = g - na;
                    e = (ma + j) / a * 360 + 1;
                    if (e > 360) e = 360;
                    ...
                    p.strokeStyle = "rgba(" + r + ", " + v + ", " + t + ", " + o + ")";
                    p.arc(f, f, c.settings.timerRadius, 0, e * i, false);
                    p.stroke()
                }
            }, 20)
        }
        ...
        function Ia(a, b, d) {
            var f = 0;
            if (a == "centerTop" || a == "centerCenter" || a == "centerBottom" || b < d) f = Math.floor((b - d) / 2);
            else if (a == "rightTop" || a == "rightCenter" || a == "rightBottom") f = b - d;
            return f
        }
        function Ja(a, b, d) {
            var f = 0;
            if (a == "leftCenter" || a == "centerCenter" || a == "rightCenter" || b < d) f = Math.floor((b - d) / 2);
            else if (a == "leftBottom" || a == "centerBottom" || a == "rightBottom") f = b - d;
            return f
        }
        function Sa() {
            var a = w.length;
            ...
            c.settings.thumbnailOrientation == "horizontal" ? q.addClass("horizontal") : q.addClass("vertical");
            ...
            for (var b = 0; b < a; b++) {
                ...
                if (w[b].thumbnailCaption) {
                    ...
                    var i = h('<div class="content">' + w[b].thumbnailCaption + "</div>").appendTo(f);
                    ...
                    if (c.settings.hideThumbnailCaption) if (c.settings.thumbnailCaptionEffect == "slide") c.settings.thumbnailCaptionPosition == "top" ? f.css({
                ...
                d.hover(function() {
                    ...
                    c.settings.thumbnailTooltip && ab(parseInt(h(this).attr("rel")))
                }, function() {
                    h(this).hasClass("select") || h(this).removeClass("over");
                    var m = h(this).find(".caption");
                    if (m) if (c.settings.hideThumbnailCaption) if (c.settings.thumbnailCaptionEffect == "slide") c.settings.thumbnailCaptionPosition == "top" ? m.stop().animate({
            ...
            if (c.settings.fadeNavigationThumbnails) {
                ...
                q.hover(function() {
                    h.browser.msie && parseInt(h.browser.version) < 9 ? q.css("filter", "") : q.stop().animate({
                        opacity: 1
            ...
            if (c.settings.visibleThumbnails < a) {
                if (c.settings.thumbnailArrows) {
                    ...
                    if (c.settings.thumbnailOrientation == "horizontal") {
                        q.css("width", b * Math.min(a, c.settings.visibleThumbnails) + f.outerWidth(true) + i.outerWidth(true));
                        x.css("left", Math.round((q.outerWidth() - x.outerWidth()) / 2));
                        f.css({
                            top: Math.round((q.outerHeight() - f.outerHeight()) / 2)
                        });
                        i.css({
                            top: Math.round((q.outerHeight() - i.outerHeight()) / 2)
                        })
                    } else {
                        q.css("height", d * Math.min(a, c.settings.visibleThumbnails) + f.outerHeight(true) + i.outerHeight(true));
                        x.css("top", Math.round((q.outerHeight() - x.outerHeight()) / 2));
                        f.css({
                            left: Math.round((q.outerWidth() - f.outerWidth()) / 2)
                        });
                        i.css({
                ...
                if (c.settings.thumbnailButtons) {
                    var g = h('<div class="buttons"></div>').appendTo(q),
                        j;
                    for (b = 0; b < S; b++) {
                    ...
                    if (c.settings.fadeThumbnailButtons) {
                        h.browser.msie && parseInt(h.browser.version) < 9 ? g.hide() : g.css("opacity", 0);
                        q.hover(function() {
                            h.browser.msie && parseInt(h.browser.version) < 9 ? g.show() : g.stop().animate({
                                opacity: 1
                            }, c.settings.thumbnailButtonsShowDuration)
                        }, function() {
                            h.browser.msie && parseInt(h.browser.version) < 9 ? g.hide() : g.stop().animate({
                                opacity: 0
                            }, c.settings.thumbnailButtonsShowDuration)
                        })
                    }
            ...
            if (c.settings.navigationThumbnailsCenter) {
                j = {};
                if (c.settings.thumbnailOrientation == "horizontal") j.left = (A.outerWidth(true) - q.outerWidth(true)) / 2;
                else j.top = (A.outerHeight(true) - q.outerHeight(true)) / 2;
                q.css(j)
            }
        ...
        function ab(a) {
            if (a = w[a].thumbnailTooltip) {
                ...
                var d = -b.outerWidth() / 2,
                    f = 0 - b.outerHeight() - parseInt(b.css("marginBottom"));
                b.css({
        ...
        function V(a) {
            var b = c.settings.thumbnailOrientation == "horizontal" ? x.outerWidth() : x.outerHeight(),
                d = a * b;
            J = a;
            if (J == S - 1) d = H - b;
            xa();
    ...
    complete: function() {
        ya()
            ...
            function Ma() {
                ...
                g = c.settings.thumbnailOrientation == "horizontal" ? i : e,
                j = c.settings.thumbnailOrientation == "horizontal" ? f : d,
                ...
                za = setInterval(function() {
                    ...
                    if (O > f && O < f + i && P > d && P < d + e) {
                        a = Math.round((-((H - g + 200) * (((c.settings.thumbnailOrientation == "horizontal" ? O : P) - j) / g)) + 100 - o) * c.settings.thumbnailMouseScrollSpeed / 100);
                        o += a
            ...
            function db() {
                ...
                d, f = c.settings.thumbnailOrientation == "horizontal" ? "left" : "top",
                i = c.settings.thumbnailOrientation == "horizontal" ? x.outerWidth(true) : x.outerHeight(true);
                x.bind("mousewheel", function(e, g) {
                    e.preventDefault();
                    if (!Aa) {
                        xa();
                        Aa = true;
            ...
            function cb() {
                function a() {
                    j = (c.settings.thumbnailOrientation == "horizontal" ? O : P) - f.offset()[k] - m;
                    b()
                }
                function b() {
                    if (j < 0) j = 0;
                    else if (j > parseInt(f.css(u)) - parseInt(i.css(u))) j = parseInt(f.css(u)) - parseInt(i.css(u));
                    ea && i.css(k, j);
                ...
                var d = h('<div class="scrollbar"></div>').appendTo(q),
                f = h('<div class="track"></div>').appendTo(d);
                ...
                var e = h('<div class="back"></div>').appendTo(d),
                g = h('<div class="forward"></div>').appendTo(d),
                j = 0,
                m, o = 0,
                s = 0,
                u = c.settings.thumbnailOrientation == "horizontal" ? "width" : "height",
                ...
                if (c.settings.fadeThumbnailScrollbar) {
                    h.browser.msie && parseInt(h.browser.version) < 9 ? d.hide() : d.css("opacity", 0);
                    q.hover(function() {
            ...
            function oa() {
                if (c.settings.thumbnailScrollbar && !ea) {
                    ...
                    value = -Na() * (parseInt(a.css(sizeProp)) - parseInt(b.css(sizeProp)));
            ...
            function Wa(a, b, d, f) {
                ...
                switch (b) {
                    case "randomPattern":
                        ...
                        break;
                    case "topToBottom":
                        for (g = 0; g < f; g++) for (e = 0; e < d; e++) i.push(l(a, e, g));
                        break;
                    case "bottomToTop":
                        for (g = f - 1; g >= 0; g--) for (e = d - 1; e >= 0; e--) i.push(l(a, e, g));
                        break;
                    case "rightToLeft":
                        for (e = d - 1; e >= 0; e--) for (g = f - 1; g >= 0; g--) i.push(l(a, e, g));
                        break;
                    case "leftToRight":
                        for (e = 0; e < d; e++) for (g = 0; g < f; g++) i.push(l(a, e, g));
                        break;
                    ...
                    case "horizontalMarginToCenter":
                        if (d % 2) {
                            for (e = 0; e < Math.floor(d / 2); e++) for (g = 0; g < f; g++) {
                                i.push(l(a, e, g));
                                i.push(l(a, d - 1 - e, g))
                            }
                            for (b = 0; b < f; b++) i.push(l(a, Math.floor(d / 2), b))
                        } else for (e = 0; e < Math.floor(d / 2); e++) for (g = 0; g < f; g++) {
                            i.push(l(a, e, g));
                            i.push(l(a, d - 1 - e, g))
                        }
                        break;
                    case "horizontalCenterToMargin":
                        if (d % 2) for (b = 0; b < f; b++) i.push(l(a, Math.floor(d / 2), b));
                        for (e = Math.floor(d / 2) - 1; e >= 0; e--) for (g = 0; g < f; g++) {
                            i.push(l(a, e, g));
                            i.push(l(a, d - 1 - e, g))
                        }
                        break;
                    case "verticalMarginToCenter":
                        if (f % 2) {
                            for (g = 0; g < Math.floor(f / 2); g++) for (e = 0; e < d; e++) {
                                i.push(l(a, e, g));
                                i.push(l(a, e, f - 1 - g))
                            }
                            for (b = 0; b < d; b++) i.push(l(a, b, Math.floor(f / 2)))
                        } else for (g = 0; g < Math.floor(f / 2); g++) for (e = 0; e < d; e++) {
                            i.push(l(a, e, g));
                            i.push(l(a, e, f - 1 - g))
                        }
                        break;
                    case "verticalCenterToMargin":
                        if (f % 2) for (b = 0; b < d; b++) i.push(l(a, b, Math.floor(f / 2)));
                        for (g = Math.floor(f / 2) - 1; g >= 0; g--) for (e = 0; e < d; e++) {
                            i.push(l(a, e, g));
                            i.push(l(a, e, f - 1 - g))
                        }
                        break;
                    case "skipOneTopToBottom":
                        for (g = 0; g < f; g++) {
                            for (e = j; e < d; e += 2) i.push(l(a, e, g));
                            j == 0 ? j = 1 : j = 0
                        }
                        j = 1;
                        for (g = 0; g < f; g++) {
                    ...
                    case "skipOneLeftToRight":
                        for (e = 0; e < d; e++) {
                            for (g = j; g < f; g += 2) i.push(l(a, e, g));
                            j == 0 ? j = 1 : j = 0
                        }
                        j = 1;
                        for (e = 0; e < d; e++) {
                    ...
                    case "skipOneVertical":
                        if (f % 2) for (g = 0; g < f; g++) {
                            for (e = j; e < d; e += 2) {
                                if (g == Math.floor(f / 2)) {
                                    g++;
                                    for (b = 1 - d % 2; b < d; b += 2) {
                                        i.push(l(a, b, Math.floor(f / 2)));
                                        l(a, b - 1, Math.floor(f / 2)) != undefined && i.push(l(a, b - 1, Math.floor(f / 2)))
                                    }
                                }
                                i.push(l(a, e, g));
                                i.push(l(a, e, f - g - 1))
                    ...
                    r = f < d ? f : d;
                        ...
                        for (u = 0; u < m; u++) {
                            ...
                            o--;
                            for (g = k; g < s; g++) i.push(l(a, d - k, g));
                            s--;
                            for (b = o; b >= d - o; b--) i.push(l(a, b - 1, s));
                            for (j = s - 1; j >= f - s; j--) i.push(l(a, k - 1, j))
                        }
                        if (r % 2) {
                            if (r == f) for (e = k++; e < o; e++) i.push(l(a, e, k - 1));
                            if (r == d) for (g = k++; g < s; g++) i.push(l(a, d - k, g))
                        }
                        break;
                    case "spiralMarginToCenterCCW":
                        ...
                        m = Math.floor(r / 2);
                        for (u = 0; u < m; u++) {
                            for (g = k++; g < s; g++) i.push(l(a, k - 1, g));
                            s--;
                            for (e = k; e < o; e++) i.push(l(a, e, f - k));
                            o--;
                            for (b = s; b >= f - s; b--) i.push(l(a, o, b - 1));
                            for (j = o - 1; j >= d - o; j--) i.push(l(a, j, k - 1))
                        }
                        if (r % 2) {
                            if (r == f) for (e = k++; e < o; e++) i.push(l(a, e, f - k));
                            if (r == d) for (g = k++; g < s; g++) i.push(l(a, k - 1, g))
                        }
                        break;
                ...
                if (c.settings.xmlSource) {
                    ...
                    h.ajax({
                        ...
                        success: function(a) {
                            ...
                            h(b).find("slide").each(function() {
                                var d = {};
                                d.properties = {};
                                for (var f = 0; f < h(this).children().length; f++) {
                                    var i = h(this).children()[f];
                                    if (i.nodeName == "lightboxContent") {
                                        X.push(h(this).find("lightboxContent").text());
                                        ka.push(h(this).find("lightboxTitle").text() || "");
                                        la.push(h(this).find("lightboxDescription").text() || "");
                                        d.lightbox = {
                                            lightbox_index: X.length - 1
                                        }
                                    }
                                    if (i.nodeName != "lightboxContent" && i.nodeName != "lightboxTitle" && i.nodeName != "lightboxDescription") d[i.nodeName] = h(this).find(i.nodeName).text()
                                }
                                for (f = 0; f < qa.length; f++) {
                                    i = qa[f];
                                    var e = h(this).attr(i);
                                    d.properties[i] = e == undefined ? c.settings[i] : e
                                }
                                w.push(d)
                            });
                            I()
                    ...
                    n.children().each(function(a) {
                        ...
                        for (var d = 0; d < h(this).children().length; d++) {
                            ...
                            if (h(f).is("a")) if (h(f).hasClass("lightbox")) {
                                ...
                                b.path = h(f).find("img").attr("src");
                                b.link = h(f).attr("href");
                                if (h(f).attr("target")) b.properties.linkTarget = h(f).attr("target")
                            } else if (h(f).is("img")) if (h(f).hasClass("thumbnail")) {
                                b.thumbnail = h(f).attr("src");
                                if (h(f).attr("title")) b.thumbnailCaption = h(f).attr("title")
                            } else b.path = h(f).attr("src");
                            else if (h(f).hasClass("html")) b.html = h(f);
                            else b[h(f).attr("class")] = h(f).html()
                        }
                        for (d = 0; d < qa.length; d++) {
                            f = qa[d];
                            var i;
                            if (c.settings.slideProperties) if (c.settings.slideProperties[a]) i = c.settings.slideProperties[a][f];
                            b.properties[f] || (b.properties[f] = i == undefined ? c.settings[f] : i)
                        }
                        w.push(b)
                    });
                    n.empty();
        ...
        h.fn.advancedSlider = function(ra) {
            for (var T = [], I = 0; I < this.length; I++) {
                if (!this[I].slider) this[I].slider = new Oa(this[I], ra);
...
// FROM: js/jquery.lightbox-0.5.js
/**
...
// FROM: js/jquery.translate-1.4.7-debug-all.js
