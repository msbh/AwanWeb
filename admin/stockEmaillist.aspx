...
AutoEventWireup="false" CodeFile="stockEmaillist.aspx.vb" 
Inherits="admin_stockEmaillist" title="-Stock Email List-" %>
...
<ul class="myform_heading2">
            <span style="color: #3366CC">Stock Email </span>List
        </ul>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtchassis_no" runat="server"></asp:TextBox>
                                 ...
                                 runat="server" ControlToValidate="txtchassis_no" 
                                  ValidationExpression="^[a-zA-Z0-9_]*$" Display="Dynamic"
                                 ErrorMessage="Invalid Data"></asp:RegularExpressionValidator> 
                            </td>
                            <td>
...
<asp:ListItem Value="7">U.S</asp:ListItem> 
                        ...
                        <tr >
                            ...
                            <td>
                                <asp:TextBox ID="txtfile_ref" runat="server" Width="99px"></asp:TextBox>
                                 ...
                                 runat="server" ControlToValidate="txtfile_ref" 
                                  ValidationExpression="^[a-zA-Z0-9_]*$" Display="Dynamic"
                                 ErrorMessage="Invalid Data"></asp:RegularExpressionValidator> 
                            </td>
                            <td>
       ...
       <fieldset>
           <ul style="margin-left: 0px;  list-style-type:none; padding-left:0;">
               <li style="width: 80%; margin-left: 0px; float: left;">
                   <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                       AutoGenerateColumns="False" CellPadding="4" DataSourceID="ObjectDataSource1"
                       ForeColor="#333333" GridLines="None" Width="100%" EmptyDataText="- No data -"
                       PageSize="400">
                       ...
                       <Columns>
                           ...
                           <asp:BoundField DataField="MAKE_CATEGORY" HeaderText="CAT" SortExpression="MAKE_CATEGORY" />
                           <asp:BoundField DataField="FOB_PRICE" HeaderText="FOB_PRICE" SortExpression="FOB_PRICE" />
                           <asp:BoundField DataField="availability1" HeaderText="STATUS" ReadOnly="True" SortExpression="availability" />
                           <asp:BoundField DataField="globalLocation" HeaderText="LOC" SortExpression="globalLocation" />
                           <asp:BoundField DataField="FILE_REF" HeaderText="REF" SortExpression="FILE_REF">
                               <ItemStyle Wrap="False" />
                           </asp:BoundField>
                           <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" />
                           <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="stockdetails.aspx?ID={0}"
               ...
               <li style="width: 180px; margin-left:5px; float:left;">
                   
                   
                   <asp:Button ID="cmdAddStock" Width="85px"  runat="server" CssClass="btn_action"  Text="Add Chassis" />
                   <asp:Button ID="cmdEmailStock" runat="server" Width="85px" CssClass="btn_action"  Text="Email Stock" />
                   
                   <asp:GridView ID="GridView2" Width="100%" runat="server" AutoGenerateColumns="False"
                       DataSourceID="odsStockToEmail" EmptyDataText="--- No stoct in List ---" 
                       DataKeyNames="Stock_ID,Session_ID" CellPadding="4" ForeColor="#333333" 
                       GridLines="None">
                       <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                       <Columns>
...
<div>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlstatus" Name="AVAILABILITY" 
              PropertyName="SelectedValue" Type="String" DefaultValue="UNSOLD" />
    ...
    <asp:ObjectDataSource ID="odsMakeCategory" runat="server" 
        ...
        TypeName="masterdataTableAdapters.vMakeCategoryTableAdapter">
         ...
         <asp:ObjectDataSource ID="odsStockToEmail" runat="server" 
             OldValuesParameterFormatString="{0}" SelectMethod="GetData" 
             TypeName="dsStockTableAdapters.StockToEmailTableAdapter" 
             DeleteMethod="Delete" InsertMethod="Insert">
             <DeleteParameters>
                 <asp:ControlParameter ControlID="Hsession_ID" Name="session_ID" 
                     PropertyName="Value" Type="String" />
                 <asp:ControlParameter ControlID="GridView2" DefaultValue="0" Name="stock_ID" 
