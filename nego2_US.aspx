<%@ Page Title="- Negotiation - " Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="nego2_US.aspx.vb" Inherits="nego2" %>
                        ...
                        <table width="350" cellspacing="0" cellpadding="0" border="0" align="left">
                            <tbody>
                                ...
                                <tr id="currency_selector">
                                    <td>
                                        <span class="clear left bold ">Currency:
                                        </span>
                                    &nbsp;</td>
                                    <td colspan="2">
                                ...
                                <tr>
                                    <td>
                                        <span class="clear left bold ">Shipment</span>
                                    </td>
                                    <td colspan="2">
                                        <span class="right">
                                ...
                                <tr>
                                    <td>
                                        <span class="clear left">FOB Price:</span>
                                ...
                                <tr id="freightInfo">
                                    <td>
                                        <span id="car_detail_freight" class="clear left bold ">Freight:</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <span id="car_detail_vanning" class="clear left bold ">Inspection:</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <span class="clear left ">Total Cost:</span>
                                    </td>
                                    <td>
