<%@ Page Title="- Finalize Order -" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="orderfin.aspx.vb" Inherits="orderfin" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div id="myform">
        <h1 class="myform_heading">
           <%=appdata.GetLanguageString("orderfin.heading")%>
        </h1>
        ...
        <div class="content">
            <fieldset>
                <center id="orderstatus">
                    <ul>
                     <%=appdata.GetLanguageString("orderstatus2")%>
                    </ul>
                </center>
            </fieldset>
                        ...
                        <tbody>
                                    ...
                                    <table class="style1" align="right">
                                        <tr>
                                            ...
                                            <td align="right" style="font-size: 18px; font-weight: bold; color: #FFFFFF;" valign="middle">
                                                <%=appdata.GetLanguageString("Quotation")%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <b><%=appdata.GetLanguageString("AWan")%> </b>
                                            </td>
                                            <td align="right">
                                                <%=appdata.GetLanguageString("QuoteDate")%><asp:Label ID="lblquotedate" runat="server" 
                                                    Text='<%# Bind("Date") %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <i><%=appdata.GetLanguageString("QuoteDeals")%> </i>
                                            </td>
                                            <td align="right">
                                               <%=appdata.GetLanguageString("QuoteRef")%> <asp:Label ID="lblquoteref" runat="server" 
                            ...
                            <tr>
                                <td>
                                    <table class="style1">
                                        <tr>
                                            <td>
                                                <b><%=appdata.GetLanguageString("Address")%>: </b>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <b><%=appdata.GetLanguageString("Phone")%> :</b>
                                            </td>
                                            <td>
                                                (+81) 804-2528-786&nbsp;&nbsp;&nbsp; <b><%=appdata.GetLanguageString("Fax")%>: </b>( +81) 766598750
                                            </td>
                                            <td>
                                                &nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <b><%=appdata.GetLanguageString("Email")%>: </b>
                                            </td>
                                            <td>
                                                info@awan.co.jp
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <b><%=appdata.GetLanguageString("County")%>: </b>
                                            </td>
                                            <td>
                                                Japan
                                            </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table class="style1">
                                        <tr>
                                            <td>
                                               <%=appdata.GetLanguageString("To")%> :</td>
                                            <td>
                                            ...
                                            <td align="right" class="style2">
                                                  <%=appdata.GetLanguageString("Shipto")%>:</td>
                                            <td>
                           ...
                           <td>
                               ...
                               <tbody>
                                   <tr>
                                       <td>
                                          <b> <%=appdata.GetLanguageString("Portloading")%></b> </td>
                                       <td>
                                         <b> <%=appdata.GetLanguageString("portdischarge")%> </b>  </td>
                                       <td>
                                          <b> <%=appdata.GetLanguageString("paymentterms")%></b> </td>
                                   </tr>
                                   <tr>
                                       <td>
                                                            ...
                                                            <tr height="33" bgcolor="#8F8E85">
                                                                <td width="6%" align="center">
                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                        <%=appdata.GetLanguageString("PHOTO")%> </font>
                                                                </td>
                                                                <td width="53%" align="center">
                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                           <%=appdata.GetLanguageString("STOCK DETAIL")%> </font>
                                                                </td>
                                                                <td width="10%" align="center">
                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                         <%=appdata.GetLanguageString("QUANTITY")%> </font>
                                                                </td>
                                                                <td width="15%" align="center">
                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                        <%=appdata.GetLanguageString("AMOUNT")%> []</font>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td width="120" align="left">
                                                                                        <%=appdata.GetLanguageString("stocknumber")%>
                                                                                </td>
                                                                                <td width="15">
                                                                                    :
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">
                                                                                       ...
                                                                                       <%=appdata.GetLanguageString("ChassisNo")%>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">
                                                                                    STEERING
                                                                                      <%=appdata.GetLanguageString("Steering")%>
                                                                                </td>
                                                                                <td>
                                                                                    :
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">
                                                                                 <%=appdata.GetLanguageString("INSPECTIONCERT")%>
                                                                ...
                                                                <td width="58%" valign="top" align="right">
                                                                    <table width="100%" cellspacing="0" cellpadding="0" align="center">
                                                                        <tbody>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td height="20" bgcolor="#8F8E85" align="center">
                                                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                                                        <%=appdata.GetLanguageString("BANKDETAIL2")%>   </font>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                           ...
                                                                                           <tr>
                                                                                                ...
                                                                                                <%=appdata.GetLanguageString("orderfin_bankDetali")%>
                                                                                                    </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                            ...
                                                                            <tr>
                                                                       <%=appdata.GetLanguageString("bankorderfin")%> 
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td width="200" height="30" bgcolor="#8F8E85" align="center">
                                                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                                                       <%=appdata.GetLanguageString("ORDERFINTOTAL")%></font>
                                                                                                </td>
                                                                                                <td width="1">
                                                                                                </td>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td width="200" height="30" bgcolor="#4FA5FC" align="center">
                                                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                                                        <%=appdata.GetLanguageString("DUEDATE")%> </font>
                                                                                                </td>
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td width="35%" align="center">
                                                                                                                       <%=appdata.GetLanguageString("AuthorizedSignature")%> 
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="center" colspan="2">
                                                                                                                    &nbsp;&nbsp;&nbsp;&nbsp;<%=appdata.GetLanguageString("AWan")%>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </tbody>
                                                                                                    </table>
