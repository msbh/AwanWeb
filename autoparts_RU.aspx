<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="autoparts_RU.aspx.vb" Inherits="autoparts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="myform">
        <ul class="myform_heading">
            <span style="color: #F0F0F0">Автозапчасти</span>
        </ul>
        ...
        <div class="content">
            ...
            <p>
                <b>Вы ищете автозапчасти из Японии? </ B> <i> Многие полнофункциональную автозапчастей
                     находятся на японские подержанные автомобили, которые пользуются большим спросом в качестве запасных частей для
                    зарубежных рынках, а также на внутреннем рынке. Все необходимые запчасти для автомобилей
                     тщательно отобраны специалистами. Вы можете заказать все виды Используемые части автомобиля,
                     автоматический Части тела, перестроен Автозапчасти, восстановленные детали Авто, Авто электрических частей,
                     Двигатель части всех видов марок. </i>
            ...
            <fieldset>
                <legend>Автомобиль информацией </legend>
                <ul>
                    <li><span>Make </span>
            ...
            <fieldset>
                <legend>части информацией</legend>
                <ul>
                    <li style="width:180px;" ><span>Часть условия</span>
                    ...
                    <li><span style="width:300px;" >Подробнее (по убыванию, количество частей и т.д.)</span>
            ...
            <fieldset>
                ...
                <ul>
                    <li style="width:900px;">Подробная информация (если таковые имеются доставки предпочтений пожалуйста, сообщите нам)
