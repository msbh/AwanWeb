...
Partial Class reports_quotePrint
    ...
    Protected Sub Page_SaveStateComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.SaveStateComplete
        ...
        Dim filepath As String = FolderLocation & "quoteprint.pdf"
        ...
        Dim fs As New FileStream(FolderLocation & "quoteprint.pdf", FileMode.Create)
