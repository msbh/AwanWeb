<%@ Page Title="- Finalize Order -" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="orderfin_RU.aspx.vb" Inherits="orderfin" %>
        ...
        <div class="content">
            <fieldset>
                <center id="orderstatus">
                    <ul>
                        <li>1-[отгрузке детали]</li>
                        <li>2-[порядок  детали ] </li>
                        <li>3-[ грузополучатель ] </li>
                        <li class="active">4-[завершением заказ] </li>
                    </ul>
                </center>
            </fieldset>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="style1" align="right">
                                        ...
                                        <tr>
                                            <td>
                                                <i>Предложения в Japenese Подержанные автомобили </i>
                                            </td>
                                            <td align="right">
                                                Цитата работы:<asp:Label ID="lblquoteref" runat="server" 
                           ...
                           <td>
                               ...
                               <tbody>
                                   <tr>
                                       <td>
                                          <b>Порт погрузки </b> </td>
                                       <td>
                                         <b>Порт разгрузки</b>  </td>
                                       <td>
                                          <b>оплата терминов </b> </td>
                                   </tr>
                                   <tr>
                                       <td>
                                                                                                ...
                                                                                                <td height="40" align="left">
                                                                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 10px;">
                                                                                                      Наименование банка: Банк оф Токио-Мицубиси UFJ <br>
                                                                                                         ...
                                                                                                         Причина для денежных переводов: Оплата за механических транспортных средств и / или транспортных средств</font></td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </td>
