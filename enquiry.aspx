<%@ Page Title="Awan International K.K | Enquiry" Language="VB" MasterPageFile="~/MasterPage2.master"
    AutoEventWireup="false" CodeFile="enquiry.aspx.vb" Inherits="enquiry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="myform">
        ...
        <ul class="myform_heading">
         <%=appdata.GetLanguageString("negotiate.now")%>
        </ul>
        ...
        <ul>
                <asp:ValidationSummary  ID="valsummary" runat="server" CssClass="errormessages"  DisplayMode="List">
                    ...
                    <fieldset>
                        <legend><%=appdata.GetLanguageString("enquiryStockdetails")%></legend>
                        <asp:FormView ID="FormView2" runat="server" DataSourceID="odsStockSelected">
                            <ItemTemplate>
                                <ul>
                                    <li><span><%=appdata.GetLanguageString("stocknumber")%></span>
                                ...
                                <ul>
                                    ...
                                    <li><span><%=appdata.GetLanguageString("MakeModel")%> </span>
                                ...
                                <ul>
                                    <li><span><%=appdata.GetLanguageString("ModelYear")%></span>
                                        <asp:TextBox ID="txtModelYear" Enabled="False" runat="server" Text='<%# Bind("MODEL") %>'></asp:TextBox>
                                    </li>
                                    <li><span><%=appdata.GetLanguageString("Drive")%> </span>
                        ...
                        <ul>
                            <li style="width: 100%;"><span><%=appdata.GetLanguageString("enquiryYourMessage")%></span>
                    ...
                    <fieldset>
                        <legend><%=appdata.GetLanguageString("enquiryContactInfo")%></legend>
                        <ul>
                            <li><span><%=appdata.GetLanguageString("Name")%></span>
      ...
      Display="Dynamic"
       ErrorMessage="e-Mail required">
                            ...
                            <li><span><%=appdata.GetLanguageString("Company")%></span>
                            ...
                            <li><span><%=appdata.GetLanguageString("ContactNo")%></span>
                            ...
                            <li><span><%=appdata.GetLanguageString("Address")%></span>
