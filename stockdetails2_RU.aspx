<%@ Page Title="Awan International K.K | Stock Details " Language="VB" MasterPageFile="~/MasterPage2.master"
    AutoEventWireup="false" CodeFile="stockdetails2_RU.aspx.vb" Inherits="stockdetails2" %>
                    ...
                    <tr class="js_a">
                        ...
                        <td >
                            &nbsp;   &nbsp;   &nbsp; <a href="order1.aspx?id=<%#Eval("id")%>&i=1"><%=appdata.GetLanguageString("Order")%>
                                Order </a>&nbsp; <a href="nego2.aspx?id=<%#Eval("id")%>&i=1"><%=appdata.GetLanguageString("Negotiate")%></a>&nbsp;
                            <a href="enquiry.aspx?ID=<%#Eval("id")%>"><%=appdata.GetLanguageString("Enquiry")%></a>
                        </td>
                    </tr>
                                                                                                    ...
                                                                                                    <table cellpadding="0" cellspacing="2" border="0">
                                                                                                        <tbody>
                                                                                                                ...
                                                                                                                <td align="right" valign="top">
                                                                                                                    <div class="image_border">
                                                                                                                        <a href="http://www.awan.co.jp/cars_images/<%# Eval("image1") %>" class="st_size"
                                                                                                                            rel="lightbox[a]" title="<%# Eval("make") %>  <%#Eval("model_description")%>" style="padding-bottom: 2px">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="right" valign="top">
                                                                                                                    <div class="image_border">
                                                                                                                        <a href="http://www.awan.co.jp/cars_images/noimage.png" class="st_size"
                                                                                                                            rel="lightbox[a]" title="<%# Eval("make") %>  <%#Eval("model_description")%>" style="padding-bottom: 2px">
                                                                                ...
                                                                                <td valign="top" width="65%">
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="4" class="smallblack"
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td width="50%" valign="top" bgcolor="#EAEAEA">
                                                                                                    <strong> Категория автомобиля</strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <%#Eval("ENGINE_POWER")%>
                                                                                                </td>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td height="100" style="border: 1px solid #999999" align="left" valign="top">
                                                                                                    <strong>Автомобиль варианты</strong><br>
                                                                                                    <div id="features">
