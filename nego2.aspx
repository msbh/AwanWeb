<%@ Page Title="- Negotiation - " Language="VB" MasterPageFile="~/MasterPage2.master"
    AutoEventWireup="false" CodeFile="nego2.aspx.vb" Inherits="nego2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="myform">
        <span id="lblmessage" runat="server" visible="false" style="padding: 8px; font-size: 12px;"
            class="infomessages">We have recieved your negotiation. We will get back to you
            shortly. </span>
        <asp:FormView ID="FormView1" Width="100%" runat="server" DataSourceID="odsnegotiate"
            ...
            <EditItemTemplate>
                <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("negtiation_ID") %>' />
                <div class="car_detail_left">
                    ...
                    <ul>
                        <strong>
                            <%=appdata.GetLanguageString("Vehicleoptions")%>
                            :</strong><br>
                        <div id="features">
        ...
        <asp:ObjectDataSource ID="odsnegotiate" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
            SelectMethod="GetData" TypeName="dsServicesTableAdapters.Select_NegotiateTableAdapter"
            UpdateMethod="Update">
            <DeleteParameters>
