<%@ Page Title="VIew Client Quotation" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="viewquote.aspx.vb" Inherits="viewquote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="myform">
        <h1 class="myform_heading">
            <span class="myform_span">Quotation View </span>
        </h1>
        <ul class="myform_line">
        </ul>
        <div class="content">
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="Quote_ID" 
            DataSourceID="odsTemFinalize" >
                <ItemTemplate>
                    <center class="js_a" style="margin: 4px;">
                        <a href="stocklist.aspx?lv=1">Stock List </a><a href="quoteList.aspx">Back to Quotation
                            List </a><a href="reports/quoteprint.aspx?id=<%# Eval("quote_ID") %>&stkid=<%# Eval("stock_id") %>"
    ...
    <asp:ObjectDataSource ID="odsTemFinalize" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" TypeName="membersTableAdapters.Select_QuoteTableAdapter">
        <SelectParameters>
