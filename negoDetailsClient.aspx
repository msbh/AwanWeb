<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" 
AutoEventWireup="false" CodeFile="negoDetailsClient.aspx.vb" 
Inherits="negoDetailsClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="myform">
        <ul class="myform_heading">
            <span style="color: #F0F0F0">Negotiation </span>Details
        </ul>
            ...
            <asp:FormView ID="FormView1" runat="server" DataSourceID="ObjectDataSource1" DefaultMode="Edit">
                <EditItemTemplate>
                    <div>
                        ...
                        <fieldset>  <legend> Negotiate </legend> 
