<%@ Control Language="VB" AutoEventWireup="false" CodeFile="footer_RU.ascx.vb" Inherits="Controls_footer" %>
<div id="footer" class="footer_sprit_images">
    <div id="container">
        <ul class="left">
            <li class="text_header">Аван Международный K.K</li>
            <li class="left">939-0304 Imizu Toyamaken готовность Косуги Сираиси 138-1 Японии</li>
            <li class="left">Nu Telefon: +81-766-59-8751 Fax: +81-766-59-8750 </li>
            <li class="left">авторским © 2010-11Аван Международный K.K. Все права защищены</li>
            <li class="left js_a">
      ...
      <ul class="topnav" id="footer_topnav_sprit_images">
            <li style="width: 67px; margin-right: 17px; margin-left: 0px;"><a href="ContactUs.aspx">связаться</a></li>
            <li style="width: 92px; margin-right: 7px; margin-left: 0px;"><a href="HowtoOrder.aspx">Как заказать</a></li>
            <li style="width: 141px;"><a style="width: 120px;" href="TermsandConditions.aspx">Условия и условия</a></li>
            <li><a href="CooperateOverView.aspx">О компании</a></li>
