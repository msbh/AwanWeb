<%@ Page Title="View Sale Invoice" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="viewsaleinvoice.aspx.vb" Inherits="viewperforma" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="myform">
        <h1 class="myform_heading">
            <span class="myform_span">Sale Invoice </span>
        </h1>
        <ul class="myform_line">
        </ul>
        <div class="content">
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="sales_ID" DataSourceID="odsTemFinalize">
                <ItemTemplate>
                    <center class="js_a" style="margin: 4px;">
                        <a href="salesinvoiceList.aspx">Back to List </a><a href="reports/salesinvprint.aspx?id=<%# Eval("sales_ID") %>&stkid=<%# Eval("stock_id") %>"
                            ...
                            <td>
                                <table class="style1" align="right">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                           Invoice Date:<asp:Label ID="lblperformadate" runat="server" 
                                                Text='<%# Eval("salesInvoice_Date") %>'></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td align="right">
                                            Invoice Ref:<asp:Label ID="lblquoteref" runat="server" 
                                                Text='<%# Eval("sales_Ref") %>'></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
    ...
    <asp:ObjectDataSource ID="odsTemFinalize" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" TypeName="membersTableAdapters.SaleInvoiceTableAdapter">
        <SelectParameters>
