<%@ Page Title="- Order Consignee Details -" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="orderconsignee.aspx.vb" Inherits="orderconsignee" %>
...
<div id="myform" >
   <h1 class="myform_heading">
            ...
            <%=appdata.GetLanguageString("OrderConsignee.heading")%>
        ...
        <fieldset>
                <center id="orderstatus">
                    <ul>
                       <%=appdata.GetLanguageString("orderstatus")%>
                    </ul>
                </center>
            </fieldset>
       ...
       <table class="lvconsignee">
                <tr>
                    <td class="col heading">
                       <%=appdata.GetLanguageString("Information")%>
                        Consignee Information</td>
                    <td>
                        &nbsp;</td>
                </tr>
                <tr>
                    <td class="col"> 
                      <%=appdata.GetLanguageString("Name")%>
                        </td>
                    <td>
                ...
                <tr>
                    <td class="col">
                         ...
                         <%=appdata.GetLanguageString("Email")%>
                        </td>
                    <td>
                ...
                <tr>
                    <td class="col">
                            ...
                            <%=appdata.GetLanguageString("Address")%>
                        </td>
                    <td>
                ...
                <tr>
                    <td class="col">
                               ...
                               <%=appdata.GetLanguageString("County")%>
                        </td>
                    <td>
                ...
                <tr>
                    <td class="col">
                               ...
                               <%=appdata.GetLanguageString("City")%>
                        </td>
                    <td>
                ...
                <tr>
                    <td class="col heading">
                        ...
                        <%=appdata.GetLanguageString("NotifyParty")%>
                        </td>
                    <td>
                ...
                <tr>
                    <td class="col">
                           ...
                           <%=appdata.GetLanguageString("PaymentOptions")%>
                ...
                <tr>
                    <td class="col">
                         <%=appdata.GetLanguageString("Comments")%>
                       </td>
                    <td>
