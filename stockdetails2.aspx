<%@ Page Title="Awan International K.K | Stock Details " Language="VB" MasterPageFile="~/MasterPage2.master"
    AutoEventWireup="false" CodeFile="stockdetails2.aspx.vb" Inherits="stockdetails2" %>
    ...
    <div id="myform">
            ...
            <asp:FormView ID="FormView1" runat="server" DataSourceID="odsStockDetails">
                <ItemTemplate>
                    ...
                    <tr class="js_a">
                        ...
                        <h4>
                   <%# Eval("C_TYPE") %>   &nbsp; Price: <%# Eval("currency_short_name") %> 
                         <%# Eval("FOB_PRICE") %>
                        ...
                        <td >
                            &nbsp;   &nbsp;   &nbsp; <%--<a href="order1.aspx?id=<%#Eval("id")%>&i=1"><%=appdata.GetLanguageString("Order")%>
                                </a>&nbsp; <a href="nego2.aspx?id=<%#Eval("id")%>&i=1"><%=appdata.GetLanguageString("Negotiate")%></a>--%>&nbsp;
                            <a href="enquiry.aspx?ID=<%#Eval("id")%>"><%=appdata.GetLanguageString("Negotiate")%></a>
                        </td>
                    </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td colspan="2" valign="top">
                                                                                                    ...
                                                                                                    <asp:DataList ID="DataList2" runat="server" DataSourceID="ObjectDataSource1" 
                                                                                                        ...
                                                                                                        <ItemTemplate>
                                                                                                            <div class="image_border">
                                                                                                                <a href="http://www.awan.co.jp/cars_images/<%# Eval("Image_name") %>" class="st_size"
                                                                                                                    rel="lightbox[a]" title="" style="padding-bottom: 2px">
                                                                                                                    <img src="http://www.awan.co.jp/cars_images/<%# Eval("Image_name") %>" width="100"
                                                                                                                        height="75" border="0" onmouseover="document.images.main_pic.src='http://www.awan.co.jp/cars_images/<%# Eval("Image_name") %>'"></a>
                                                                                                            </div>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:DataList>
                                                                                                    ...
                                                                                                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                                                                                        ...
                                                                                                        TypeName="dsStockTableAdapters.Select_StockImagesTableAdapter">
                                                                                                        <SelectParameters>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td width="50%" valign="top" bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("stocknumber")%>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td width="50%" valign="top" bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("ChassisNo")%>
                                                                                                   </strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <%#Eval("CHASSIS_NO")%>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td width="50%" valign="top" bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("Make")%>
                                                                                                    </strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <%#Eval("MAKE")%>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td width="50%" valign="top" bgcolor="#EAEAEA">
                                                                                                    <strong>
                                                                                                    <%=appdata.GetLanguageString("Model")%>
                                                                                                    </strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <%#Eval("model_description")%>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td width="50%" valign="top" bgcolor="#EAEAEA">
                                                                                                    <strong>
                                                                                                     <%=appdata.GetLanguageString("VehicleGrade")%>
                                                                                                    </strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <%#Eval("veh_grade")%>
                                                                                            ...
                                                                                            <tr bgcolor="#EAEAEA">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("ModelYear")%></strong>
                                                                                                </td>
                                                                                                <td bgcolor="#FFFFFF">
                                                                                                    <%#Eval("MODEL")%>
                                                                                                </td>
                                                                                            ...
                                                                                            <tr bgcolor="#EAEAEA">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("Status")%></strong>
                                                                                                </td>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("Mileage")%></strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <strong>
                                                                                                        <%#Eval("mileage")%></strong>
                                                                                            ...
                                                                                            <tr bgcolor="#EAEAEA">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("Steering")%>
                                                                                                   </strong>
                                                                                                </td>
                                                                                                <td bgcolor="#FFFFFF">
                                                                                                    <%#Eval("drive")%>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                    ...
                                                                                                    <strong><%=appdata.GetLanguageString("EngineCClable")%></strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <%#Eval("CC")%>
                                                                                                </td>
                                                                                            ...
                                                                                            <tr bgcolor="#EAEAEA">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                    <strong><%=appdata.GetLanguageString("Fuel")%></strong>
                                                                                                </td>
                                                                                                <td bgcolor="#FFFFFF">
                                                                                                    <%#Eval("FUEL_TYPE")%>
                                                                                                </td>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                     ...
                                                                                                     <strong><%=appdata.GetLanguageString("Transmission")%></strong>
                                                                                            ...
                                                                                            <tr bgcolor="#EAEAEA">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                       ...
                                                                                                       <strong><%=appdata.GetLanguageString("Seats")%></strong>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                ...
                                                                                                <strong><%=appdata.GetLanguageString("Door")%></strong>
                                                                                                </td>
                                                                                                <td>
                                                                                                    <%#Eval("DOOR")%>
                                                                                                </td>
                                                                                            ...
                                                                                            <tr bgcolor="#EAEAEA">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                      ...
                                                                                                      <strong><%=appdata.GetLanguageString("colorlable")%></strong>
                                                                                                </td>
                                                                                                <td bgcolor="#FFFFFF">
                                                                                                    <%#Eval("COLOR")%>
                                                                                                </td>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                   ...
                                                                                                   <strong><%=appdata.GetLanguageString("InteriorColor")%></strong>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                     ...
                                                                                                     <strong><%=appdata.GetLanguageString("Type")%></strong>
                                                                                            ...
                                                                                            <tr bgcolor="#FFFFFF">
                                                                                                <td bgcolor="#EAEAEA">
                                                                                                  <strong><%=appdata.GetLanguageString("Location")%></strong>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td height="100" style="border: 1px solid #999999" align="left" valign="top">
                                                                                                     ...
                                                                                                     <strong><%=appdata.GetLanguageString("Vehicleoptions")%></strong>
                                                                                              <br>
                                                                                                    <div id="features">
        ...
        <asp:ObjectDataSource ID="odsStockDetails" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetData" 
                TypeName="dsStockTableAdapters.Select_StockTableAdapter">
            <SelectParameters>
