<%@ Page Title="- Select Vehicle to Order -" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="order1_RU.aspx.vb" Inherits="order1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="myform">
        ...
        <h1 class="myform_heading"> 
            <span class="myform_span">Фондовой  </span> Заказать
        ...
        <div class="content js_a" >
           ...
           <fieldset> <legend>Фондовой Заказать </legend>
               <ul>
