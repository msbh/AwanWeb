<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="Default_US.aspx.vb" Inherits="_Default" Title="Awan International K.K | Home Page" %>
                        ...
                        <div class="box-content-container">
                            <div class="box-content">
                                ...
                                <div id="QuickSearch">
                                    ...
                                    <ul>
                                        <li style="width: 70px; color: #989393; height: 16px; margin-top: 6px;"><span>Make</span></li>
                                        <li>
                                    ...
                                    <ul>
                                        <li style="width: 70px; color: #989393; height: 16px; margin-top: 6px;"><span>Model</span></li>
                                        <li>
                                    ...
                                    <ul>
                                        <li style="width: 70px; color: #989393; height: 16px; margin-top: 6px;"><span>Year</span></li>
                                        <li>
                                    ...
                                    <ul>
                                        <li style="width: 70px; color: #989393; height: 16px; margin-top: 6px;"><span>Steering</span></li>
                                        <li>
                                    ...
                                    <ul>
                                        <li class="js_a"><a onclick="quicksearch();">Search</a></li>
                                    </ul>
                                </div>
                                <div class="box-footer">
                                    <div class="box-footer-padding">
                                        <a href="stocklist.aspx?lv=1">Advance Search </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box-center">
                    <div class="box-content-container">
                        <div class="box-content">
                            ...
                            <div class="box-footer">
                                <div class="box-footer-padding">
                                    <a href="stocklist.aspx?displaytype=1&lv=1">Click here to view more </a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-center">
                    <div class="box-content-container">
                        <div class="box-content">
                            ...
                            <div class="box-footer">
                                <div class="box-footer-padding">
                                    <a href="stocklist.aspx?displaytype=2&lv=1">Click here to view more </a>
                                </div>
                            </div>
                        </div>
                    </div>
