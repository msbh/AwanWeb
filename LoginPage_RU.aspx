<%@ Page Title="Awan International K.K | Login Page" Language="VB" MasterPageFile="~/MasterPage2.master"
    AutoEventWireup="false" CodeFile="LoginPage_RU.aspx.vb" Inherits="LoginPage" %>
...
<div id="myform">
        <ul class="myform_heading">
            <span style="color: #F0F0F0">Пользователи</span>&nbsp;Войти страницу
        </ul>
        <ul class="myform_line">
        </ul>
        <div class="content">
            <center class="js_a">
                <a href="membership.aspx">Станьте нашим ценным членом, все, что вам нужно сделать, просто заполните
                    форме! И это все.
 </a>
                <br />
                <br />
                            ...
                            <tr>
                                <td>
                                    <table border="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">е-мейл</asp:Label>
                                            </td>
                                            <td>
